...
:: the documentation: https://docs.camunda.org/optimize/3.6/technical-guide/setup/installation/
::
...
set OPTIMIZE_CLASSPATH="%BASEDIR%config;%BASEDIR%lib\*;%BASEDIR%optimize-backend-3.6.3.jar"
...
echo.
echo Starting Camunda Optimize 3.6.3...
echo.
